val f = stream {
  init = (true, const (0.0), const (0.0), const (0.0), const (0.0), const (0.0), const (0.0), const (0.0));
  step ((first, x_init, x_prev0, x_prev1, x_prev2, x_prev3, x_prev4, x_prev5), obs) =
    if first then (
      ...
      (x0, (false, x0, const (0.0), const (0.0), const (0.0), const (0.0), const (0.0), x0))
    ) else (
      let x = sample (gaussian (x_prev0, 1.0)) in
      let () = observe (gaussian (x, 1.0), obs) in
      (x, (false, x_init, x_prev1, x_prev2, x_prev3, x_prev4, x_prev5, x))
    )
}
